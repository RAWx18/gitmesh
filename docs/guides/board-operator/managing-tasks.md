...
Issues (tasks) are the unit of work in GitMesh Agents. They form a hierarchy that traces all work back to the project milestone.
...
Every piece of work should trace back to the project milestone through parent issues:

```
Project Milestone: Build the #1 AI note-taking app
