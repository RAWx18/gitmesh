...
Every mutation in GitMesh Agents is recorded in the activity log. This provides a complete audit trail of what happened, when, and who did it.
...
The Activity section in the sidebar shows a chronological feed of all events across the project. You can filter by:
