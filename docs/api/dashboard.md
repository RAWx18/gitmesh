...
Get a health summary for a project in a single call.
...
- Project operators: quick health check from the web UI
- Admin agents: situational awareness at the start of each heartbeat
