...
| **GitHub Copilot** | AGENTS.md + `.github/copilot-instructions.md` | `.github/instructions/*.instructions.md` (`applyTo`) | `.vscode/mcp.json` | announced | `.github/agents/*.md` | Copilot CLI hooks; coding-agent org policy is server-side; VS Code auto-approve flags in `settings.perm.json`-style booleans (no hard deny — see ZacheryGlass finding §4.6) |
...
- **T1.4** `copilot` detector (`.github/copilot-instructions.md`, `.github/instructions/*` + `applyTo`, `.github/agents/`, `.vscode/mcp.json`, auto-approve booleans, AGENTS.md flag).
